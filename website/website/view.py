...
def run_model(image_file):
    ...
    model = models.load_model(os.path.join(settings.BASE_DIR,'model/model_data/weights.hdf5'))
    sentence = decoder.greedy_decoder(model,enc_img[0],get_vocab_dictionaries.get_word_dictionary(),get_vocab_dictionaries.get_id_dictionary(),40)
    data = dict()
